...
class SPVPositionsProjectDeptTypeSearch extends StatefulWidget {
  SPVPositionsProjectDeptTypeSearch({super.key});

  @override
  State<SPVPositionsProjectDeptTypeSearch> createState() =>
      _SPVPositionsProjectDeptTypeSearchState();
}

class _SPVPositionsProjectDeptTypeSearchState
    extends State<SPVPositionsProjectDeptTypeSearch> {
  ...
  downloadExcelFile(AllInProvider provider) async {
    ...
    List excelData = [
      {
        "svp_Department_Type": "Dep. Type",
        "total": "S",
        "p_Total": "P",
        "t_Total": "V",
      },
      ...provider.spvAnalysisProjectDeptTypeData
    ];
    ...
    for (int i = 0; i < excelData.length; i++) {
      sheet
          ...
          .value = '${excelData[i]['svp_Department_Type']}';
  ...
  applyFilter(context, statusOfApplyingFilter) {
    AllInProvider provider = Provider.of(context, listen: false);
    ...
    if (statusOfApplyingFilter) {
      Map<String, String> spvAnalysisProjectFilterData = {
        'SearchProjectID': provider.spvProjectId.toString(),
      ...
      provider.setSpvAnalysisRequiredFilters(
          context, 3, spvAnalysisProjectFilterData, false, false);
    } else {
      Map<String, String> spvAnalysisProjectFilterData = {
        'SearchProjectID': provider.spvProjectId.toString(),
        'Department': provider.deptFilterIds.join(','),
  ...
  returnOflfineSTotal() {
    AllInProvider provider = Provider.of(context, listen: false);
    int total = provider.spvAnalysisProjectDeptTypeData
  ...
  void initState() {
    AllInProvider provider = Provider.of(context, listen: false);
    gradeFilter = provider.grandFilterValue;
    spv_Dept_Type_value = provider.spv_Dept_Type;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.transparent,
        title: Text(
          "${provider.selectedRegionName} -- ${provider.selectedProjectName}",
          style: TextStyle(color: Colors.black),
        ),
        leading: InkWell(
          onTap: () {
                                    ...
                                    InkWell(
                                      onTap: () {
                                        ...
                                        Map<String, String>
                                            spvAnalysisProjectFilterData = {
                                          'SearchProjectID':
                                              provider.spvProjectId.toString(),
                                          'Department':
                                              provider.deptFilterIds.join(','),
                                          'Region': '',
                                          'ProjectCategory': "",
                                          'Project': '',
                                          'Grade': gradeFilter,
                ...
                Consumer<AllInProvider>(builder: (context, person, _) {
                  return Container(
                    ...
                    child: DataTable(
                      ...
                      columns: <DataColumn>[
                        DataColumn(
                          label: returnTableColumnLable('Dep. Type'),
                        ),
                        DataColumn(
                      ...
                      rows: provider.isOfflineData
                          ? <DataRow>[
                              ...provider.spvAnalysisProjectDeptTypeData.map(
                                (e) {
                                  return DataRow(
                                    ...
                                    cells: <DataCell>[
                                      DataCell(
                                        InkWell(
                                          onTap: () {
                                            print("Calling ");
                                            provider.spvProjectDepTypeID =
                                                e['svp_Dept_Type_ID'];
                                            provider.selectedProjectDeptTypeName =
                                                e['svp_Department_Type'];
                                            if (e['svp_Department_Type'] !=
                                                "Grand Total") {
                                              Map<String, String>
                                                  spvAnalysisProjectFilterData =
                                                  {
                                                'SearchProjectID': provider
                                                    .spvProjectId
                                                    .toString(),
                                                'SearchDeptTypeID': provider
                                                    .spvProjectDepTypeID
                                                    .toString(),
                                                'Department': '',
                                                'Region': '',
