...
class SPVAnalysisProjectScreen extends StatefulWidget {
  SPVAnalysisProjectScreen({super.key});

  @override
  State<SPVAnalysisProjectScreen> createState() =>
      _SPVAnalysisProjectScreenState();
}

class _SPVAnalysisProjectScreenState extends State<SPVAnalysisProjectScreen> {
  static const _chars =
  ...
  downloadExcelFile(AllInProvider provider) async {
    ...
    List excelData = [
      ...
      ...provider.spvAnalysisProjectData
    ];
    ...
    if (Platform.isAndroid) {
      if (await _requestPermission(Permission.storage) &&
        ...
        try {
          File(
              "${directory.path}/  SPV Analysis - Project $randomNameToDownloadSameFileMultiTime.xlsx")
                              ...
                              child: MultiSelectDialogField(
                                ...
                                onConfirm: (results) {
                                  setState(() {
                                    ...
                                    print(provider.masterProjectValues);
  ...
  applyFilter(context, statusForApplyingFilter) {
    AllInProvider provider = Provider.of(context, listen: false);
    ...
    if (statusForApplyingFilter) {
      ...
      provider.setSpvAnalysisRequiredFilters(
          context, 2, spvAnalysisProjectFilterData, false, false);
    } else {
      Map<String, String> spvAnalysisProjectFilterData1 = {
        'SearchRegionID': provider.spvRegionId.toString(),
        'Department': provider.deptFilterIds.join(','),
        'Region': '',
        'ProjectCategory': '',
      ...
      provider.setSpvAnalysisRequiredFilters(
          context, 3, spvAnalysisProjectFilterData1, true, false);
    }
  }

  returnOflfineSTotal() {
    AllInProvider provider = Provider.of(context, listen: false);
    int total = provider.spvAnalysisProjectData
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.transparent,
        title: Text(
          "SPV Analysis -- ${provider.selectedRegionName}",
          style: TextStyle(color: Colors.black),
        ),
        leading: InkWell(
          onTap: () {
                  ...
                  return Container(
                    ...
                    child: DataTable(
                        ...
                        rows: provider.isOfflineData
                            ? <DataRow>[
                                ...provider.spvAnalysisProjectData.map(
                                  (e) {
                                    return DataRow(
